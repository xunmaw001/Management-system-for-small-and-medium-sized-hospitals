...
public class ChuyuanxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ChuyuanxinxiEntity chuyuanxinxi, 
		...
		if(tableName.equals("yonghu")) {
			chuyuanxinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yisheng")) {
			chuyuanxinxi.setYishengzhanghao((String)request.getSession().getAttribute("username"));
		}
