			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.shoushufei" type="text" :readonly="ro.shoushufei" name="shoushufei" id="shoushufei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">护理费：</label>
						<div class="layui-input-block">
							<input v-model="detail.hulifei" type="text" :readonly="ro.hulifei" name="hulifei" id="hulifei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
                ...
                computed: {
                    zongjia: {
                    get: function () {
                        return 0+parseFloat(this.detail.xiangmujiage)+parseFloat(this.detail.shoushufei)+parseFloat(this.detail.hulifei) || ''
                    }
                    },
                },
				methods: {
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('chuyuanxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('chuyuanxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
