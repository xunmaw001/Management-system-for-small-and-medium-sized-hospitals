			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.xiangmujiage" type="text" :readonly="ro.xiangmujiage" name="xiangmujiage" id="xiangmujiage" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">诊费：</label>
						<div class="layui-input-block">
							<input v-model="detail.zhenfei" type="text" :readonly="ro.zhenfei" name="zhenfei" id="zhenfei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">输液费：</label>
						<div class="layui-input-block">
							<input v-model="detail.shuyefei" type="text" :readonly="ro.shuyefei" name="shuyefei" id="shuyefei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
                ...
                computed: {
                    zongjia: {
                    get: function () {
                        return 0+parseFloat(this.detail.xiangmujiage)+parseFloat(this.detail.zhenfei)+parseFloat(this.detail.shuyefei) || ''
                    }
                    },
                },
				methods: {
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('menzhenxiangmu/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('menzhenxiangmu' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
