				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.yaopinbianhao" type="text" :readonly="ro.yaopinbianhao" name="yaopinbianhao" id="yaopinbianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="yaopinleibie" id="yaopinleibie" lay-filter="yaopinleibie"  >
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.picihao" type="text" :readonly="ro.picihao" name="picihao" id="picihao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.shengchandanwei" type="text" :readonly="ro.shengchandanwei" name="shengchandanwei" id="shengchandanwei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">生产地址：</label>
						<div class="layui-input-block">
							<input v-model="detail.shengchandizhi" type="text" :readonly="ro.shengchandizhi" name="shengchandizhi" id="shengchandizhi" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">药品图片：</label>
						<div v-if="detail.yaopintupian" class="layui-input-block">
							<img id="yaopintupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :src="baseurl+detail.yaopintupian">
							<input type="hidden" :value="detail.yaopintupian" id="yaopintupian" name="yaopintupian" />
						</div>
						<div class="layui-input-block">
							<button v-if="!ro.yaopintupian" type="button" class="layui-btn btn-theme" id="yaopintupianUpload">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				http.request(`option/yaopinleibie/yaopinleibie`,'get',{},(res)=>{
					vue.yaopinleibie = res.data
                                ...
                                jquery('#shengchanriqi').val(getCurDate());
				laydate.render({
					elem: '#shengchanriqi'
				});
                                jquery('#youxiaoqizhi').val(getCurDate());
				laydate.render({
					elem: '#youxiaoqizhi'
				});
				// 上传图片
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='youxiaoqizhi'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.youxiaoqizhi = true;
                                                jquery('#youxiaoqizhi').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='shengchandanwei'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shengchandanwei = true;
                                                continue;
                                        }
                                        if(o=='shengchandizhi'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shengchandizhi = true;
                                                continue;
                                        }
                                        if(o=='yaopintupian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.yaopintupian = true;
                                                continue;
                                        }
                                        if(o=='jinji'){
                                                vue.detail[o] = obj[o];
