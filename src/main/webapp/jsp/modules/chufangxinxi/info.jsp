						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="chufangdanhao" name="chufangdanhao" class="form-control" v-model="ruleForm.chufangdanhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>药品名称</label>
									...
									<input id="chuchufang" name="chuchufang" class="form-control" v-model="ruleForm.chuchufang" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>用户账号</label>
