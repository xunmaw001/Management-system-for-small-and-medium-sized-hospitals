...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">处方信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>处方信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">处方信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yishengzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入医生账号" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chufangdanhao')">处方单号<i id="chufangdanhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('yaopinjiage')">药品价格<i id="yaopinjiageIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('chuchufang')">出处方<i id="chuchufangIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chufangdanhaoCell  = document.createElement('td');

						 chufangdanhaoCell.innerHTML = item.chufangdanhao;

			row.appendChild(chufangdanhaoCell);
			...
			var yaopinjiageCell  = document.createElement('td');

						 yaopinjiageCell.innerHTML = item.yaopinjiage;

			row.appendChild(yaopinjiageCell);
			...
			var chuchufangCell  = document.createElement('td');

						  chuchufangCell.innerHTML = item.chuchufang; 

			row.appendChild(chuchufangCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chufangxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"chufangxinxi");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"chufangxinxi");
