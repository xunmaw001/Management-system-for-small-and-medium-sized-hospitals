						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="shoushufei" name="shoushufei" class="form-control" v-model="ruleForm.shoushufei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>护理费</label>

									<input id="hulifei" name="hulifei" class="form-control" v-model="ruleForm.hulifei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>总价</label>
