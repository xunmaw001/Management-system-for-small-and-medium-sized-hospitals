		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑挂号信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>挂号信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑挂号信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">挂号信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>挂号时间</label>
										<div id="guahaoshijianDate" class="input-append date form_datetime">
											<input id="guahaoshijian-input" name="guahaoshijian" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "guahaoxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("guahaoxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("guahaoxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("guahaoxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#guahaoshijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#guahaoshijian-input").val(ruleForm.guahaoshijian);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.guahaobianhao != null && res.data.guahaobianhao != ''){
						...
						$("#guahaobianhao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.guahaoshijian != null && res.data.guahaoshijian != ''){

						$("#guahaoshijian-input").val(res.data.guahaoshijian);
						$('#guahaoshijianFileName').val(res.data.guahaoshijian)
					}
