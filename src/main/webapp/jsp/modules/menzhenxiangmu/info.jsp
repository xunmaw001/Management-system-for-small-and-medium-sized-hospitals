						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="zhenfei" name="zhenfei" class="form-control" v-model="ruleForm.zhenfei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>输液费</label>

									<input id="shuyefei" name="shuyefei" class="form-control" v-model="ruleForm.shuyefei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>总价</label>
