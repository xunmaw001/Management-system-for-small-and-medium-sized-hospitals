...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">门诊项目管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>门诊项目列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">门诊项目列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zhenfei')">诊费<i id="zhenfeiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shuyefei')">输液费<i id="shuyefeiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zhenfeiCell  = document.createElement('td');

						 zhenfeiCell.innerHTML = item.zhenfei;

			row.appendChild(zhenfeiCell);
			var shuyefeiCell  = document.createElement('td');

						 shuyefeiCell.innerHTML = item.shuyefei;

			row.appendChild(shuyefeiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("menzhenxiangmu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"menzhenxiangmu");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"menzhenxiangmu");
