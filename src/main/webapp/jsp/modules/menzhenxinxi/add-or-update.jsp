...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>科室编号</label>
										<input id="keshibianhao" name="keshibianhao" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>科室名称</label>
									...
									<div class="form-group col-md-6">
										<label>科室类型</label>
										<select id="keshileixingSelect" name="keshileixing" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>医生账号</label>
									...
									<div class="form-group col-md-6">
										<label>坐诊时间</label>
										<input name="zuozhenshijian" id="zuozhenshijian" name="zuozhenshijian" class="form-control" placeholder="坐诊时间">
									</div>
									<div class="form-group col-md-6">
										<label>专业特长</label>
										<textarea  name="zhuanyetezhang" class="form-control" id="zhuanyetezhang" rows="3"></textarea>
									</div>
	...
	<script>
		...
		var keshileixingOptions = [];

		function keshibianhaoUuid(){
			if($("#keshibianhao").val() == null || $("#keshibianhao").val() == "null" || $("#keshibianhao").val() == ""){
				$("#keshibianhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
		function keshileixingSelect(){
			http("option/keshileixing/keshileixing","GET",{},(res)=>{
				if(res.code == 0){
					keshileixingOptions = res.data;
					var nullOption = document.createElement('option');
					var keshileixingSelect = document.getElementById('keshileixingSelect');
					keshileixingSelect.appendChild(nullOption);
					for(var i=0;i<keshileixingOptions.length;i++){
						var keshileixingOption = document.createElement('option');
						keshileixingOption.setAttribute('name','keshileixingOption');
						keshileixingOption.setAttribute('value',keshileixingOptions[i]);
						keshileixingOption.innerHTML = keshileixingOptions[i];									
						if(ruleForm.keshileixing == keshileixingOptions[i]){
							keshileixingOption.setAttribute('selected','selected');
						}
						keshileixingSelect.appendChild(keshileixingOption);
					}
				}
			});
		}	
		...
		function dataBind(){
			...
			$("#keshibianhao").val(ruleForm.keshibianhao);	
			$("#keshimingcheng").val(ruleForm.keshimingcheng);	
			var keshileixingOptions = document.getElementsByClassName("keshileixingOption");
			for(var keshileixingCount = 0; keshileixingCount < keshileixingOptions.length;keshileixingCount++){
				if(keshileixingOptions[keshileixingCount].getAttribute('value') == ruleForm.keshileixing){
					keshileixingOptions[keshileixingCount].setAttribute('selected','selected');
				}
			}
			...
			$("#zhuanyetezhang").val(ruleForm.zhuanyetezhang);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.keshibianhao != null && res.data.keshibianhao != ''){

						$("#keshibianhao").val(res.data.keshibianhao);
						$("#keshibianhao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.keshileixing != null && res.data.keshileixing != ''){
						...
						var keshileixingOptions = document.getElementsByClassName("keshileixingOption");
						for(var keshileixingCount = 0; keshileixingCount < keshileixingOptions.length;keshileixingCount++){
							if(keshileixingOptions[keshileixingCount].getAttribute('value') == res.data.keshileixing){
								keshileixingOptions[keshileixingCount].setAttribute('selected','selected');
							}
						}
					}
					...
					if(res.data != null && res.data != '' && res.data.zuozhenshijian != null && res.data.zuozhenshijian != ''){
						...
						$("#zuozhenshijian").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.zhuanyetezhang != null && res.data.zhuanyetezhang != ''){

						$("#zhuanyetezhang").val(res.data.zhuanyetezhang);
					}
