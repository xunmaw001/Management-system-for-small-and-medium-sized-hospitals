...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('keshibianhao')">科室编号<i id="keshibianhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var keshibianhaoCell  = document.createElement('td');

						 keshibianhaoCell.innerHTML = item.keshibianhao;

			row.appendChild(keshibianhaoCell);
			...
			var zhuanyetezhangCell  = document.createElement('td');

						  if(item.zhuanyetezhang != null && item.zhuanyetezhang != "" && item.zhuanyetezhang.length >= 11){
			  	zhuanyetezhangCell.innerHTML = item.zhuanyetezhang.substring(0, 10) + "..."; 
			  }else{
			  	zhuanyetezhangCell.innerHTML = item.zhuanyetezhang;
			  }


			row.appendChild(zhuanyetezhangCell);
			...
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'guahaoxinxi','','','')");
