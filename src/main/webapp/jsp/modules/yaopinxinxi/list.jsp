...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shengchandanwei')">生产单位<i id="shengchandanweiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shengchandizhi')">生产地址<i id="shengchandizhiIcon" class="fa fa-sort"></i></th>
											<th>药品图片</th>
											<th>禁忌</th>
											<th>操作</th>
										</tr>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shengchandanweiCell  = document.createElement('td');

						 shengchandanweiCell.innerHTML = item.shengchandanwei;

			row.appendChild(shengchandanweiCell);
			var shengchandizhiCell  = document.createElement('td');

						 shengchandizhiCell.innerHTML = item.shengchandizhi;

			row.appendChild(shengchandizhiCell);
			var yaopintupianCell  = document.createElement('td');

				                var yaopintupianImg = document.createElement('img');
			yaopintupianImg.setAttribute('src',baseUrl+item.yaopintupian);
			yaopintupianImg.setAttribute('height',100);
			yaopintupianImg.setAttribute('width',100);
			yaopintupianCell.appendChild(yaopintupianImg);


			row.appendChild(yaopintupianCell);
			var jinjiCell  = document.createElement('td');

						  if(item.jinji != null && item.jinji != "" && item.jinji.length >= 11){
			  	jinjiCell.innerHTML = item.jinji.substring(0, 10) + "..."; 
			  }else{
			  	jinjiCell.innerHTML = item.jinji;
			  }


			row.appendChild(jinjiCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "处方"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'chufangxinxi','','','')");
			if(crossBtnControl('处方') == true){
