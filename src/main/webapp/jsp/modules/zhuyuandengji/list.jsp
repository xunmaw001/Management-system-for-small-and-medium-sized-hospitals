...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">住院登记管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>住院登记列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">住院登记列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zhuyuanbianhao')">住院编号<i id="zhuyuanbianhaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('bingfangbianhao')">病房编号<i id="bingfangbianhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zhuyuanbianhaoCell  = document.createElement('td');

						 zhuyuanbianhaoCell.innerHTML = item.zhuyuanbianhao;

			row.appendChild(zhuyuanbianhaoCell);
			var bingfangbianhaoCell  = document.createElement('td');

						 bingfangbianhaoCell.innerHTML = item.bingfangbianhao;

			row.appendChild(bingfangbianhaoCell);
			...
			var ruzhuyuanyinCell  = document.createElement('td');
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zhuyuandengji/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zhuyuandengji");
